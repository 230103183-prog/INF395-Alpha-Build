...
Original file is located at
    https://colab.research.google.com/drive/1YtXFoyanCs8uRKYLpaBc8uy8ZgD2qyyt
"""
...
def load_ml_components():
    data_grouping = joblib.load('fraud_model_rf_nlp.pkl')
    data_segments = joblib.load('fraud_model_segments.pkl')
    data_audio    = joblib.load('fraud_model_audio.pkl')
    data_hybrid   = joblib.load('fraud_model_hybrid.pkl')
